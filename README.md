...
Установка: при установке нужно использовать кодировку UTF-8 для корректного отображения. Скрипт содержит русские сообщения  без UTF-8  будут отображаться некорректно.
